          ...
          <div className="relative w-full max-w-4xl h-[85vh] bg-white dark:bg-neutral-900 rounded-2xl overflow-hidden shadow-xl">
            ...
            <div className="flex justify-between items-center px-4 py-3 border-b dark:border-neutral-800">
              ...
              <div className="flex items-center gap-4">
                <a
                  href="https://drive.google.com/file/d/1oilapGPyonZ7j2KFL7QXxDnRX6XaIacW/view?usp=sharing"
                  target="_blank"
            ...
            {/* RESUME PREVIEW */}
            <iframe
              src="https://drive.google.com/file/d/1oilapGPyonZ7j2KFL7QXxDnRX6XaIacW/preview?usp=sharing"
